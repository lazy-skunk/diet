...
from apps.utils.directory_manager import DirectoryManager
...
class SingletonLogger:
    ...
    def get_logger(cls) -> Logger:
        ...
        cls._ensure_logger_exists()

        return cls._logger

    @classmethod
    def _ensure_logger_exists(cls) -> None:
    ...
    def _initialize(cls) -> None:
        if cls._logger is None:
            ...
            DirectoryManager.ensure_directory(log_path)
